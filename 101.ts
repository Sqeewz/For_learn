...
//ตัวอย่างการประกาศตัวแปรด้วย var
var City: string = "Bangkok"; // ตัวแปร City เป็นชนิดข้อความ (string)
var Temperature: number = 30; // ตัวแปร Temperature เป็นชนิดตัวเลข (number)
